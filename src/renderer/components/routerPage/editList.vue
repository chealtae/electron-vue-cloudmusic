...
export default {
    ...
    methods:{ 
        ...
        getListInfo(){
            ...
            this.$axios.post(`/SongListInfo/getSongListInfo?`,info).then((res) => {
                    if(res.data.success){
                        ...
                        this.imageUrl = getImgSrc(res.data.playListDeatils.image);
                        let tags = res.data.tagRes
                        
                        tags.forEach(item => {
                            this.tagValue.push(item.itemid)
                        })
                        console.log(this.tagValue)
                    }
                })
        ...
        async getTag(){
            return this.$axios.get(`Tag/getListTag`).then((res) => {
                if(res.data.success){
