<template>
    <div style="height:100%;overflow:auto">
        ...
        <div class="content">
            <div class="user_item" v-for="item in fansList" :key="item.id" @click="go2Details(item.id)">
...
export default {
    data() {
        return {
            ...
            nickname:'',
            fansList:[],
            fansNumber:Number(this.$route.query.id),
        }
    },
    mounted(){
        this.getfans();
    ...
    methods:{
        getfans(){
            ...
            this.$axios.post(`/User/getfans`,info).then(res => {
                if(res.data.success){
